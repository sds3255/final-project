			                    ...
			                    <div class="single-product-area mb-30">
			                        <div class="product_image">
			                           ...
			                           <a href="productDetailView.do?fundIdx=${fundingPageFashionEndDate.fundIdx}&memberId=${user.memberId}&fundMakerId=${getBoardListAll.fundMakerId}">
			                           		<img style="width: 350px; height: 210px;" class="normal_img" src="img/fundingMainImg/${fundingPageFashionEndDate.fundMainImg }">
			                            </a>
			                            ...
			                            <c:if test="${fn:contains(bool,fundingPageFashionEndDate.fundIdx)}">
		                            		<div class="product_wishlist">
						                 		<a href="javascript:fundLikeUpdate(${fundingPageFashionEndDate.fundIdx })">
						                 			<i id="heart1${fundingPageFashionEndDate.fundIdx }" class="fa-solid fa-heart-circle-minus"></i>
						                 		</a>
						         			</div>
			                            </c:if>
			                    		<c:if test="${not fn:contains(bool,fundingPageFashionEndDate.fundIdx)}">
			                    			<div class="product_wishlist">
						                 		<a href="javascript:fundLikeUpdate(${fundingPageFashionEndDate.fundIdx })">
					                 				<i id="heart${fundingPageFashionEndDate.fundIdx }" class="fa-solid fa-heart-circle-plus"></i>
						                 		</a>
						         			</div>
			                    		</c:if>
			                        </div>
