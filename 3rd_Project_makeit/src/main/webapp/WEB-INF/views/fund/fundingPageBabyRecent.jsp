			                    ...
			                    <div class="single-product-area mb-30">
			                        <div class="product_image">
			                           ...
			                           <a href="productDetailView.do?fundIdx=${fundingPageBabyRecent.fundIdx}&memberId=${user.memberId}&fundMakerId=${getBoardListAll.fundMakerId}">
			                           		<img style="width: 350px; height: 210px;" class="normal_img" src="img/fundingMainImg/${fundingPageBabyRecent.fundMainImg }">
			                            </a>
			                            ...
			                            <c:if test="${fn:contains(bool,fundingPageBabyRecent.fundIdx)}">
		                            		<div class="product_wishlist">
						                 		<a href="javascript:fundLikeUpdate(${fundingPageBabyRecent.fundIdx })">
						                 			<i id="heart1${fundingPageBabyRecent.fundIdx }" class="fa-solid fa-heart-circle-minus"></i>
						                 		</a>
						         			</div>
			                            </c:if>
			                    		<c:if test="${not fn:contains(bool,fundingPageBabyRecent.fundIdx)}">
			                    			<div class="product_wishlist">
						                 		<a href="javascript:fundLikeUpdate(${fundingPageBabyRecent.fundIdx })">
					                 				<i id="heart${fundingPageBabyRecent.fundIdx }" class="fa-solid fa-heart-circle-plus"></i>
						                 		</a>
						         			</div>
			                    		</c:if>
			                        </div>
